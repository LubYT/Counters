...
class Counter8:
    ...
    def produce(self):
        if self.game.Counter_7.first:
            self.produce_count=(self.produce_base*self.count*self.multi*self.game.Achievements.achieve_mult('8 Counter')*self.game.Tickspeed.get_time()*self.game.CB.multi_list[7]
