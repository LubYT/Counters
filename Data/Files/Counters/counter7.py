...
class Counter7:
    ...
    def produce(self):
        if self.game.Counter_6.first:
            self.produce_count=(self.produce_base*self.count*self.game.Achievements.achieve_mult('7 Counter')*self.multi*self.game.Tickspeed.get_time()*self.game.CB.multi_list[6]
