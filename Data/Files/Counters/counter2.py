...
class Counter2:
    ...
    def produce(self):
        if self.game.Counter_1.first:
            self.produce_count=(self.produce_base*self.count*self.multi*self.game.Tickspeed.get_time()*self.game.Achievements.achieve_mult('2 Counter')*self.game.CB.multi_list[1]
