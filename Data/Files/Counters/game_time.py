...
class Tickspeed:
    ...
    def place(self):
        self.text=self.game.main_canvas.create_text(self.game.geometry[0]//2,120,anchor='center',text='Counters speed: '+str(self.tickspeed),fill='#c22f40',font=('bahnschrift',10))
