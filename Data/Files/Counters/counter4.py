...
class Counter4:
    ...
    def produce(self):
        if self.game.Counter_3.first:
            self.produce_count=(self.produce_base*self.game.Achievements.achieve_mult('4 Counter')*self.count*self.multi*self.game.Tickspeed.get_time()*self.game.CB.multi_list[3]
