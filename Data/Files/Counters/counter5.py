...
class Counter5:
    ...
    def produce(self):
        if self.game.Counter_4.first:
            self.produce_count=(self.produce_base*self.game.Achievements.achieve_mult('5 Counter')*self.count*self.multi*self.game.Tickspeed.get_time()*self.game.CB.multi_list[4]
