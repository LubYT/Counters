...
class Counter3:
    ...
    def produce(self):
        if self.game.Counter_2.first:
            self.produce_count=(self.produce_base*self.count*self.game.Achievements.achieve_mult('3 Counter')*self.multi*self.game.Tickspeed.get_time()*self.game.CB.multi_list[2]
